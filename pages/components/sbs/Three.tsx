  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="bg-rose-400 lg:grid lg:grid-cols-2 lg:gap-4">
          <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-28 xl:px-20 flex items-center">
            <div className="">
              ...
              <motion.button
                ...
                className="group h-12 w-36 my-8 rounded-full border-2 border-white
   overflow-hidden flex justify-center items-center flex-col"
                    ...
                    >
                      <a href="https://twitter.com/underbelly" target="_blank">
                        <svg
                          ...
                          width="24"
                          height="24"
                          className="fill-current text-white hover:text-cyan-200"
                        >
          ...
          <div className="aspect-w-7 aspect-h-6 mix-blend-luminosity ">
            <img
              className="object-contain"
              src="/images/sbs/three.png"
              alt="App screenshot"
            />
          </div>
        </div>
